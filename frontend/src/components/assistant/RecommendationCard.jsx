                    ...
                    >
                        ...
                        <div className="p-3.5">
                            ...
                            <div className="flex items-start justify-between mb-2">
                                <div>
                                    <Link to={`/book/${provider.id}`} className="text-sm font-bold text-surface-800 hover:text-primary-700 underline transition-colors block">
                            ...
                            <a 
                                ...
                                className="flex items-start gap-1.5 text-xs text-surface-500 mb-2 hover:text-primary-600 transition-colors group cursor-pointer"
                                title="Get Directions"
                            >
                                <svg className="w-3.5 h-3.5 mt-0.5 group-hover:text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                                </svg>
                                <span>
                                    <span className="font-semibold block">{provider.location}</span>
